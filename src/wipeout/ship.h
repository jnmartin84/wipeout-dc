...
// Timings
#define recip30 0.03333333333333333333333333333333f
#define UPDATE_TIME_INITIAL   (200.0 * recip30) 
#define UPDATE_TIME_THREE     (150.0 * recip30) 
#define UPDATE_TIME_RACE_VIEW (100.0 * recip30) 
#define UPDATE_TIME_TWO       (100.0 * recip30) 
#define UPDATE_TIME_ONE       ( 50.0 * recip30) 
#define UPDATE_TIME_GO        (  0.0 * recip30) 
//(1.0/30.0))
//(1.0/30.0))
//(1.0/30.0))
//(1.0/30.0))
...
#define FIXED_TO_FLOAT(V) ((V) * 0.000244140625f/* (1.0/4096.0) */)
...
#define PITCH_VELOCITY(V) ((V) * 0.0625f/* (1.0/16.0) */)
#define YAW_VELOCITY(V) ((V) * 0.015625f/* (1.0/64.0) */)
